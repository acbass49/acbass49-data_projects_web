...
As some of you may know, my work is fairly political, so I have developed a habit of staying up to date on news and politics. Recently, social media has made some headlines including leaders speaking at congressional hearings and reporters expressing concern over its influence on elections and worrying about censorship. So, amid all of this (and the rest of this post is a much lighter tone than this intro), I wanted to download my personal data from Facebook to show an overview of the role its played in my life since I got my account.
...
I filtered these results for the last year to show my current most popular emojis. When I made this graph showing all of my data on reactions, I just got a bunch of "Like"s because that was the only reactions available for a long time; hence, I decided to filter. Hmm perhaps I should try using the care/angry emojis.
