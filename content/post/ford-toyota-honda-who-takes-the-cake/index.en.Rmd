...
tags:
  ...
  - Data Visualization
  - Statistics
description: 'A look into US car sales data in the last 25 years...'
thumbnail: images/favicon2.png
---
A look into US car sales data in the last 25 years...

![](https://media.giphy.com/media/rUE9CTmsYMbbOz2MqD/giphy.gif#center)
...
![](/./about_files/brand_over_time.png#center)
...
![](/./about_files/yearly_sales_over_time.png#center)
...
![](/./about_files/total_sales.png#center)
...
![](/./about_files/percent_difference_sold.png#center)
...
var disqus_config = function () {
  this.page.url = 'https://alexbass.me/post/2021-01-13-ford-toyota-honda-who-takes-the-cake/';  // Replace PAGE_URL with your page's canonical URL variable
  this.page.identifier = 'PAGE_IDENTIFIER1cdsaadd'; // Replace PAGE_IDENTIFIER with your page's unique identifier variable
};
