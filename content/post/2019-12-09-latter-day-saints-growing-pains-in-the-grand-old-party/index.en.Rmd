...
---
![](/./about_files/iu-3.jpeg#center){width=474px height=321px}
...
![](/./about_files/dem_issues.png#center)
...
![](/./about_files/dev_table.png#center)

As you can see, Republicans and Latter-days Saints are a lot closer together than Democrats and Latter-day Saints on average. In fact, on average Latter-day Saints and Democrats are almost as far apart as Republicans and Democrats. 
...
![](/./about_files/impeach_trump.png#center)

Even when asking about impeaching Trump, only 1 in 4 Latter-day Saints agreed with this compared to almost 3 in 4 Democrats. However, even though Latter-day Saints are much closer to Republicans than Democrats on impeaching Trump, Latter-day Saints actually are almost twice as far from Republicans on this issue as they are on average. In that, we see more evidence of some Latter-day Saint hesitancy toward Trump.

But enough on this. 

Another reason Latter-day Saints stick around is shown in the next figure. Below are the **issues where Latter-day Saints leaned the furthest RIGHT** by percentage point. These could represent the conservative positions Latter-day Saints cling to the strongest.

![](/./about_files/strict.png#center){width=100% height=350px}

Latter-day Saints also stick around because some church teachings are also aligned with conservative policy positions.
