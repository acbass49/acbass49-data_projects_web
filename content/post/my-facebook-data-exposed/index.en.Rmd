...
var disqus_config = function () {
  this.page.url = 'https://alexbass.me/post/facebook-exposed/';  // Replace PAGE_URL with your page's canonical URL variable
  this.page.identifier = 'PAGE_IDENTIFIER1cdsa'; // Replace PAGE_IDENTIFIER with your page's unique identifier variable
};
