...
![](/./about_files/resume_2.png#center)
...
![](/./about_files/resume_3.png#center)
...
Turned out because I was most interested in the pdf export, I ended up using mostly LaTeX and only some plain Markdown in my Quarto document. Though I haven't experimented with exporting to html, I noticed that I wasn't able to export to word when using custom LaTeX. It can only be rendered in pdf form which is fine for my interests. But, for those interested in a Microsoft Word or html output, my template won't work for you.

Finished product below...

![](/./about_files/resume_1.png#center)
...
If you would like to clone the repo, copy the code below in the terminal and update the files to have your information!
...
var disqus_config = function () {
  this.page.url = 'https://alexbass.me/post/resume-template-with-latex-and-quarto/';  // Replace PAGE_URL with your page's canonical URL variable
  this.page.identifier = 'PAGE_IDENresume'; // Replace PAGE_IDENTIFIER with your page's unique identifier variable
};
