...
I'm excited to introduce a project I've been working on.

(**TL:DR I created a weekly COVID email update. Scroll to the bottom to opt-in** 🙂)

In the past few days, Europe has seen a third wave of COVID19 surge through and several other countries are reporting higher cases this week. All of this begs the question of whether COVID will have a *third* strong wave after the what we've seen from the delta variant. Here is a tweet from the World Health Organization detailing some of this:

```{r echo=FALSE}
blogdown::shortcode('tweet', '1456285383000567810')
```

Right when I think I don't have to worry about COVID anymore, I find myself *once again* click through a website checking case, death, and vaccination rates. Instead of that, I created an automated email that sends on Saturday mornings with the latest case/death/vaccination data, so you can be informed with a weekly check-in nationally and for your state.
