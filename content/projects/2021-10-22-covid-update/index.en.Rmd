...
var disqus_config = function () {
  this.page.url = 'https://alexbass.me/projects/weekly-covid-update/';  // Replace PAGE_URL with your page's canonical URL variable
  this.page.identifier = 'PAGE_IDENTIFIEadd'; // Replace PAGE_IDENTIFIER with your page's unique identifier variable
};
